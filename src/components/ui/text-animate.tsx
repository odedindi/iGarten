...
const animationVariants = {
    ...
    shiftInUp: {
        ...
        child: {
            hidden: {
                y: "250%", // Starting from below but not too far to ensure a dramatic but manageable shift.
                transition: {
...
const TextAnimate: FC<Props> = ({
    ...
    if (type === "rollIn" || type === "whipIn") {
        return (
            <div
                className={cn(
                    "mt-10 px-8 py-5 pb-8 text-3xl font-black text-black md:text-5xl dark:text-neutral-100",
                    className
                )}
            >
    ...
    return (
        <motion.div
            ...
            animate="visible"
            className={cn(
                "mt-10 px-8 py-5 pb-8 text-4xl font-black text-black md:text-5xl dark:text-neutral-100",
                className
            )}
            {...props}
        >
